...
function M.perform_clean(dir)
    ...
    local items = shell_utils.execute_command("ls " .. dir)
    for filename in items:gmatch("[^\r\n]+") do
        ...
        if ext then
            ...
            if category == nil then
                ...
                local target_dir = defaults.get_directory(category)
                shell_utils.execute_command("mv " .. target .. "/" .. filename .. " " .. target_dir)
